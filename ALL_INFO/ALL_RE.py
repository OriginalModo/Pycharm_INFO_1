...
# Флаги: re.ASCII или re.A, re.IGNORECASE или re.I, re.MULTILINE или re.M, re.DOTALL или re.S, re.VERBOSE или re.X.
 ...
 print(re.findall(r'(?P<test>\d{2})', text))  # -> ['01', '01', '01', '23']  # Именованная Группа
 ...
 в  ASCII меньше вразы символов - соответсвенно скорость поиска и обработки особенно больших текстов выше!
