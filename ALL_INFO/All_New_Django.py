"""
 ...
 python название_файла.py  - Запуск файла в терминале   (Нужно находиться в той же директории, где расположен файл.)
 ...
 **`systeminfo`** - Показывает подробную информацию о системе.
 ...
 В браузере жмем Просмотреть код и чтобы было выбрано 'все' под словом Фильтр:    F12 (Инструменты разработчика)
